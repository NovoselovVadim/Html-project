...
"""
    def title(self,text):
        ...
        self.base=self.base[:index]+"    <title>"+text+"</title>"+"""
"""+self.base[index:]
    def paragraph(self,text):
        index = self.base.find("</body>")
        self.base = self.base[:index] + "    <p>" + text + "</p>" + """
""" + self.base[index:]
    def br(self):
        index = self.base.find("</body>")
...
""" + self.base[index:]
    def heading(self,text,number):
        index = self.base.find("</body>")
        self.base = self.base[:index] + "    <h"+str(number)+">" + text + "</h"+str(number)+">" + """
""" + self.base[index:]
    def image(self,link,width="",height=""):
        index = self.base.find("</body>")
        self.base = self.base[:index] + '    <img src="'+link+'" width="'+str(width)+'" height="'+str(height)+'" >' + """
""" + self.base[index:]
    def audio(self,link):
        index = self.base.find("</body>")
...
"""+self.base[index:]
    def video(self,link,width="",height=""):
        index = self.base.find("</body>")
        self.base = self.base[:index] + '    <video controls="" width="'+str(width)+'" heigth="'+str(height)+'">' + """
        """ + '<source src="' + link + '">' + """
    </video>""" + """
""" + self.base[index:]
    def input(self,text):
        index = self.base.find("</body>")
        self.base = self.base[:index] + '    <input placeholder="' + text + '">' + """
""" + self.base[index:]
    def textarea(self, text):
        index = self.base.find("</body>")
        self.base = self.base[:index] + '    <textarea placeholder="' + text + '">' + '</textarea>'+"""
 """ + self.base[index:]
...
""" + self.base[index:]
    def strong(self,text):
        index=self.base.find("</body>")
        self.base=self.base[:index]+"    <strong>"+text+"</strong>"+"""
"""+self.base[index:]
    def small(self,text):
        index=self.base.find("</body>")
        self.base=self.base[:index]+"    <small>"+text+"</small>"+"""
"""+self.base[index:]
    def emphasized(self,text):
        index=self.base.find("</body>")
        self.base=self.base[:index]+"    <em>"+text+"</em>"+"""
"""+self.base[index:]
    def anchor(self, link,text):
        index = self.base.find("</body>")
        self.base = self.base[:index] + '    <a href="' + link + '" target="_blank">' + text + '</a>'+"""
 """ + self.base[index:]
